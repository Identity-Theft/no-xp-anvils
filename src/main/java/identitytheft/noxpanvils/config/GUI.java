    ...
    private static Option<Boolean> createOption(String key, boolean def, Supplier<Boolean> getter, Consumer<Boolean> setter)
    {
        return Option.<Boolean>createBuilder()
                ...
                .controller(opt -> BooleanControllerBuilder.create(opt)
                        .formatValue(val -> Component.translatable(val ? "no-xp-anvils.no_xp" : "no-xp-anvils.xp"))
                        .coloured(true)
                )
                .build();
    }
    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory()
    {
        return parent -> YetAnotherConfigLib.create(
                ...
                ((defaults, config, builder) -> builder
                        .title(Component.translatable("no-xp-anvils.title"))
                        .category(ConfigCategory.createBuilder()
                                .name(Component.translatable("no-xp-anvils.title"))
